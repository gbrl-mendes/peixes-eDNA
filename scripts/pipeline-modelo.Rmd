...
Se você tem alguma dúvida ou sugestão, por favor sinta-se à vontade para escrever um e-mailpara [lgc.edna\@gmail.com](mailto:lgc.edna@gmail.com){.email}
...
O processo de demultiplex irá separar as *reads* de acordo com cada
combinação de *primers* FWD e REV a partir da tabela fornecida no passo
anterior. No final desta etapa, a pasta *raw* terá um par de arquivos R1
e R2 para cada combinação de *primers*.
