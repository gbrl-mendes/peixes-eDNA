...
o uso do pacote dada2, que utiliza do algorítmo DADA2 para inferir as
sequências exatas das variantes de amplicons (ASVs), a partir de dados
HTS *(High Throughput Sequencig)* gerados por sequenciamentos Illumina.
