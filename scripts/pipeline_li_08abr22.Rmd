...
A função mergePairs realiza a união (merge) das *reads* FWD e REV,
rejeitando os pares que não possuem sobreposição suficiente de 20 bases
(minOverlap = 20) ou que tenham mismatches (maxMismatch = 0).
