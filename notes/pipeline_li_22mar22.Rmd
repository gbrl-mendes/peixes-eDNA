...
load(file = "/home/gabriel/projetos/peixes-eDNA/analises/li_22mar22/env_li_22mar22_17h44.RData")
```
...
mergers_sps <- dada2::assignSpecies(seqs = mergers_seqtab.nochim, allowMultiple = 10,
                                refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/dez21/dada_tax_fullDB_order_SPs_dez21.fasta",
                                tryRC=TRUE,
                                n = 20000,
                                verbose = TRUE)
...
R1_sps <- dada2::assignSpecies(seqs = R1_seqtab,allowMultiple = 10,
                         # refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/jul21/dada_tax_fullDB_order_SPs_jul21.fasta",
                         refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/dez21/dada_tax_fullDB_order_SPs_dez21.fasta",
                         tryRC=TRUE,
                         n = 20000,
                         verbose = TRUE)
...
mergers_taxa <- dada2::assignTaxonomy(seqs = mergers_seqtab.nochim,
                                  refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/dez21/dada_tax_fullDB_order_dez21.fasta",
...
R1_taxa <- dada2::assignTaxonomy(seqs = R1_seqtab,
                           # refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/jul21/dada_tax_fullDB_order_jul21.fasta",
                           refFasta =  "/home/gabriel/projetos/peixes-eDNA//data/refs/db/LGC/dez21/dada_tax_fullDB_order_dez21.fasta",
                           multithread=TRUE, tryRC=TRUE,taxLevels = c("Kingdom","Phylum","Class","Order","Family", "Genus", "Species","Specimen","Basin"),
                           outputBootstraps = TRUE, verbose = TRUE )
