---
title: "Irapé eDNA - Todas Campanhas "
author: "Hilário, OH"
date: "23/12/2021"
output:
  html_document:
...
load(file = "/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/LGC_run5_22dez21-env_2021-12-25_blast.RData")
```
...
analysis_path <- "~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21"
...
prjct_rad <-c("LGC_run5_22dez21")

list.files(analysis_path)

# 2 - indicate where the raw reads are ----
run_path <- "/home/heron/runs/run5_22dez21"



## All libs are already demultiplexed
raw_libs <- "/home/heron/runs/run5_22dez21/raw" # PATH to the directory containing raw fastq files (same as in $RAW_DATA).
...
primers_n_samples <- readr::read_csv(file = "/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/data/LGC_run5_22dez21-primers_idx_samples.csv")
...
primers_seqs <-  Biostrings::readDNAStringSet(filepath = "/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/data/neo_miU_indexed_primers.fasta",format = "fasta")
...
cutadapt -e 0.10 -j 79 --no-indels --max-n 0\
 -g file:/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/data/neo_miU_indexed_primers.fasta  \
 -G file:/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/data/neo_miU_indexed_primers.fasta \
...
#list files
libs_path <- "/home/heron/runs/run5_22dez21/dmux_CDI"
...
dir.create(path = paste0(run_path,"/paired"),showWarnings = TRUE) 


for (sample in 1:nrow(sample_idx_tbl)) {

  sample_idx_tbl$FWD_R1_paired[sample] <-
    all_fnFs[grep(pattern =  paste0("/",sample_idx_tbl$`Lib name F`[sample]),x = all_fnFs)] %>% str_replace(pattern = "dmux_CDI",replacement = "paired")

  sample_idx_tbl$FWD_R2_paired[sample] <-
    all_fnRs[grep(pattern =  paste0("/",sample_idx_tbl$`Lib name F`[sample]),x = all_fnRs)] %>% str_replace(pattern = "dmux_CDI",replacement = "paired")

  sample_idx_tbl$REV_R1_paired[sample] <-
    all_fnFs[grep(pattern =  paste0("/",sample_idx_tbl$`Lib name R`[sample]),x = all_fnFs)] %>% str_replace(pattern = "dmux_CDI",replacement = "paired")

  sample_idx_tbl$REV_R2_paired[sample] <-
    all_fnRs[grep(pattern =  paste0("/",sample_idx_tbl$`Lib name R`[sample]),x = all_fnRs)] %>% str_replace(pattern = "dmux_CDI",replacement = "paired")
...
sample_levels <- c(
"be_05_08_21","be_12_07_21","be_13_07_21","be_15_07_21","bf_18_05_21","bf_19_05_21",
"branco_extracao_dez21","branco_filtragem_dez21","branco_pcr_dez21",
"IR10_fev21","L1_nov21","L1_out21",
"L2_nov21","L2_out21",
"L3_nov21","L3_out21",
"L4_nov21","L4_out21",
"Turbina_1_fev21","Turbina_1_maio21","Turbina_2_fev21","Turbina_2_mai21",
"Turbina_3_fev21","Turbina_3_maio21","Turbina_ago21","Turbina_fev_20",
"SF02.1M","SF02.1N","SFO1.1M","SFO1.1N","SFO1.2M","SFO1.2N",
"SFO10.1M","SFO10.1N","SFO10.2M","SFO10.2N","SFO11.1M","SFO11.1N",
"SFO12.1M","SFO12.1N","SFO13.2M","SFO13.2N","SFO14.1M","SFO14.1N",
"SFO15.1M","SFO15.1N","SFO15.2M","SFO15.2N",
"SFO17.1M","SFO17.1N","SFO17.2M","SFO17.2N",
"SFO18.1M","SFO18.1N","SFO18.2M","SFO18.2N",
"SFO19.1M","SFO19.1N","SFO19.2M","SFO19.2N",
"SFO2.2M","SFO2.2N","SFO20.1M",
"SFO20.1N","SFO20.2M","SFO20.2N",
"SFO23.1M","SFO23.1N","SFO23.2M","SFO23.2N",
"SFO3.1M","SFO3.1N","SFO4.1M","SFO4.1N","SFO4.2M","SFO4.2N",
"SFO5.1M","SFO5.1N","SFO5.2M","SFO5.2N","SFO6.1M","SFO6.1N",
"SFO7.2M","SFO7.2N","SFO8.1M","SFO8.1N","SFO8.2M","SFO8.2N",
"SFO9.2M","SFO9.2N","SFL1.1M","SFL1.1N","SFL10.1M","SFL10.1N",
"SFL11.1M","SFL11.1N","SFL12.1M","SFL12.1N",
"SFL13.1M","SFL13.1N","SFL13.2M","SFL13.2N",
"SFL14.1M","SFL14.1N","SFL14.2M","SFL14.2N",
"SFL15.1M","SFL15.1N","SFL15.2M","SFL15.2N",
"SFL17.1M","SFL17.1N","SFL17.2M","SFL17.2N",
"SFL18.1M","SFL18.1N","SFL18.2M","SFL18.2N",
"SFL2.2M","SFL2.2N","SFL20.2M","SFL20.2N",
"SFL22.1M","SFL22.1N","SFL23.1M","SFL23.1N",
"SFL3.1M","SFL3.1N","SFL4.1M","SFL4.1N","SFL4.2M","SFL4.2N",
"SFL5.1M","SFL5.1N","SFL5.2M","SFL5.2N",
"SFL6.1M","SFL6.1N","SFL6.2M","SFL6.2N",
"SFL7.2M","SFL7.2N",
"SFL8.1M","SFL8.1N","SFL8.2M","SFL8.2N",
"CN1M","CN1N","CN2M","CN2N","CN3M","CN3N",
"CN4M","CN4N","CN5M","CN5N","CN6M","CN6N",
"CN7M","CN7N","positive_control")
```
...
# Unify merged amplicons ----

# reverse complement the REV merged amplicon

#OBS: as we are working with mixed orientations amplicons, we must reverse the reverse-demultiplexes reads.
#movi pra 30 linhas atras
# colnames(run_seqtab_REV) <- dada2:::rc(colnames(run_seqtab_REV)) # reverse-complement


    #nao precisa pois ja inverti antes de azer a tabela la atras
# colnames(R2_seqtab) <- dada2:::rc(colnames(R2_seqtab)) # reverse-complement

  # seqtab <- mergeSequenceTables(table1 = run_seqtab_FWD, table2 = run_seqtab_REV) # the usual with single orientation
...
# all_seqtab.nochim <- removeBimeraDenovo(all_seqtab, method="consensus", multithread=TRUE, verbose=TRUE)  #minFoldParentOverAbundance??
...
#I still do not understand how is possible to have bimeras on single reads ASVs

R1_seqtab.nochim <- removeBimeraDenovo(R1_seqtab, method="consensus", multithread=TRUE, verbose=TRUE)  #minFoldParentOverAbundance??
dim(R1_seqtab.nochim)
sum(R1_seqtab.nochim)/sum(R1_seqtab) # =  0.9567811 , perda de 4.4% na abundancia -> estes 4.4% são quimeras
#count proportion of ASVs of a given length
table(nchar(getSequences(R1_seqtab.nochim)))
table(nchar(getSequences(R1_seqtab.nochim))) %>% plot()
rownames(R1_seqtab.nochim)
rownames(R1_seqtab)

R2_seqtab.nochim <- removeBimeraDenovo(R2_seqtab, method="consensus", multithread=TRUE, verbose=TRUE)  #minFoldParentOverAbundance??
dim(R2_seqtab.nochim)
sum(R2_seqtab.nochim)/sum(R2_seqtab) # =  0.9567811 , perda de 4.4% na abundancia -> estes 4.4% são quimeras
#count proportion of ASVs of a given length
table(nchar(getSequences(R2_seqtab.nochim)))
table(nchar(getSequences(R2_seqtab.nochim))) %>% plot()
rownames(R2_seqtab.nochim)
rownames(R2_seqtab)
...
# transform tibble to long format, better for ggplot
  ...
  mutate(Stage = factor(Stage, levels = c(
    # "R1 + R2 + merged non-chimeric",
                                          ...
                                          "Raw FWD_R2","Raw FWD_R1", 
                                          "Raw REV_R2","Raw REV_R1"))) 
...
#plot samples reads/abundances
  ...
  track_plot <- track_tbl %>% 
    ...
    scale_fill_manual(                     
      values = alpha(colour = inferno8[c(2,3,3,4,5,5,6,6,6,6,7,7,7,7)],
...
<!-- ![gráfico de reads](/home/heron/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/figs/LGC_run5_22dez21track_samples.ng) -->
...
samdf <- primers_n_samples[,c(
  "Run","Group","Expedition","Coleta","Sample Name","File_name","Type",
  "Point","Sub-point","Depth","Num replicates","Obs",
  "Primer","Tag pairs","Tag FWD","Tag REV",
  "Control",
...
# blast_res2 <- furrr::future_map_dfr(asvs_blast[8446:8447], get_blastn_results, num_thread = 1, .options = furrr::furrr_options(seed = NULL))
...
base::save.image(paste0(analysis_path,"/",prjct_rad,"-env_",Sys.Date(),"_blast_Bdone2.RData"))
...
#run on bash
# heron@edna:~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/swarm$ swarm -t 50 ../LGC_run5_22dez21_abd.fasta -s LGC_run5_22dez21-swarm.stats -o LGC_run5_22dez21-swarm.out -w LGC_run5_22dez21-representative_OTUs.fasta -i LGC_run5_22dez21-swarm.structure -f
...
dir.create("~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/ASVs",showWarnings = T)
...
write(neoASVs_fasta, "~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/ASVs/NeoFish_ASVs_IDed.fasta")
...
write(mifASVs_fasta, "~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/ASVs/MiFish_ASVs_IDed.fasta")
...
write(ASVs_fasta, "~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/ASVs/LGC_run5-LIngleses_ASVs_IDed_noBac.fasta")
write(ASVs_fasta, "~/prjcts/fish_eDNA/analyses/LGC_run5_22dez21/results/ASVs/LGC_run5-Irape_ASVs_IDed_noBac.fasta")
